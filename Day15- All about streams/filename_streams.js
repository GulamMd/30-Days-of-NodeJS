...
var wdata = "I am working with streams first time";
...
myWriteStream.on("finish", () => {
  console.log("data written successful using streams");
  console.log("Now trying to read same file using read streams");
